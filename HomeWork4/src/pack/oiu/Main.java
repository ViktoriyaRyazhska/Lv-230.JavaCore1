...
public class Main {
	public static void main(String[] args) throws NumberFormatException, IOException {
		...
		Dog dog1 = new Dog("kuzia", breed.Beagle, 17);
		...
		if (dog1.getAge()>dog2.getAge()&&dog1.getAge()>dog3.getAge()) {
			System.out.println("The oldest dog is "+dog1.getBreed().name()+". "+"Name is "+dog1.getName());
		} else { if (dog2.getAge()>dog3.getAge()) {
			System.out.println("The oldest dog is "+dog2.getBreed().name()+". "+"Name is "+dog2.getName());
		} else {
			System.out.println("The oldest dog is "+dog3.getBreed().name()+". "+"Name is "+dog3.getName());
